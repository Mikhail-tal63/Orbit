...
type Querier interface {
	...
	CreateRideReq(ctx context.Context, arg CreateRideReqParams) (RideRequest, error)
	...
	GetAvailableDriversBYID(ctx context.Context, dollar_1 []uuid.UUID) ([]uuid.UUID, error)
